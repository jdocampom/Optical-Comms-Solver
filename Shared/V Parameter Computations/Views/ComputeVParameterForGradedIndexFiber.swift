//
//  ComputeVParameterForGradedIndexFiber.swift
...
struct ComputeVParameterForGradedIndexFiber: View {
    ...
    var body: some View {
        let numberOfModes = NormalisedFrequencyCalculations(vParameter: vParameter, fiberType: .gradedIndex)
        ...
        return Form {
            ...
            Section(header: Text("Compute V Parameter")) {
                ...
                HStack {
                    Text("V Parameter").customStyle()
                    Spacer()
                    Text(data.computeNormalisedFrequency(wavelength: wavelength, fiberRadius: fiberRadius, numericalAperture: numericalAperture, fiberType: .gradedIndex))
                }
            }
            .navigationTitle("Graded Index Fiber")
            .navigationBarTitleDisplayMode(.inline)
        }
    }
}

struct ComputeVParameterForGradedIndexFiber_Previews: PreviewProvider {
    static var previews: some View {
        ComputeVParameterForGradedIndexFiber()
    }
}
