//
//  ComputeNAFromRefractiveIndices.swift
...
struct ComputeNAFromRefractiveIndices: View {
        ...
        return Form {
            ...
            Section(header: Text("Results")) {
                HStack {
                    ...
                    Spacer()
                    Text(data.compute(from: .refractionIndices, n1: coreRefractiveIndex, n2: claddingRefractiveIndex))
                }
            }
...
struct ComputeNAFromRefractiveIndices_Previews: PreviewProvider {
    static var previews: some View {
        ComputeNAFromRefractiveIndices()
    }
}
